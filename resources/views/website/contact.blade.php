				...
				<form action="">
					<div class="flex flex-col md:flex-row items-center space-x-0 md:space-x-10 mb-7">
						<div class="w-full md:w-1/2">
							...
							<input type="text" class="form-input focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary" name="first_name" required>
						</div>

						<div class="w-full md:w-1/2 mt-7 md:mt-0">
							<label for="" class="text-white block">Apellido(s)*</label>
							<input type="text" class="form-input focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary" name="last_name" required>
						</div>
					</div>

					<div class="mb-7">
						<label for="" class="text-white block">Correo electrónico*</label>
						<input type="email" class="form-input focus:outline-none focus:border-secondary focus:ring-1 focus:ring-secondary" name="email" required>
					</div>
